...
['DOMContentLoaded', 'DOMLazyLoad'].forEach(event => {
    document.addEventListener(event, () => {
        ...
        let wpadminbarHeight = !wpadminbar ? 0 : wpadminbar.offsetHeight;

        // if (!firstSection.classList.contains('single-content')) {
        //     firstSection.style.marginTop = ( headerHeight - wpadminbarHeight ) + 'px';
        // }
        ...
        const startPosition = header.offsetTop;
        ...
        function toggleStoriesNavigation() {
            ...
            storiesNav.style.display = lockedButtons.length > 0 ? 'none' : 'flex';
        }
        ...
        let interval =setInterval(() => {
            ...
            if(canRunSwiper) {
                ...
                const swiper = new Swiper('.stories__slider', {
                    slidesPerView: 1,
                    navigation: {
                        nextEl: '.stories__nav .swiper-button-next',
                        prevEl: '.stories__nav .swiper-button-prev',
                    },
                });
                ...
                const swiperStories = new Swiper('.stories-slider', {
                    slidesPerView: 1,
                    navigation: {
                        nextEl: '.stories-nav .swiper-button-next',
                        prevEl: '.stories-nav .swiper-button-prev',
                    },
                    watchOverflow: true,

                    on: {
                        init() {
                            toggleStoriesNavigation();
                        },
                ...
                const swiperCrmSliders = document.querySelectorAll('.clm-software-slider');

                swiperCrmSliders.forEach((slider) => {
                    new Swiper(slider, {
                        slidesPerView: 'auto',
                        loop: true,
                        speed: 5000,
        ...
        tabSolutionClick('.card-badge', '.information_block-wrap');
        ...
        function newFaqItemClick() {
            const items = document.querySelectorAll('.faq-header');
            const itemParents = document.querySelectorAll('.faq-item');
            const itemBodys = document.querySelectorAll('.faq-body');
