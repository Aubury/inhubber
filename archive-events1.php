    ...
    <section class="events-content">
        <div class="container">
            ...
            foreach ($dates as $date) {
                $date->timestamp = strtotime($date->name);
            }
            ...
            <?php if ($dates): ?>
                <?php foreach ($dates as $date): ?>
                    <?php $events = new WP_Query([
                        ...
                        'orderby' => 'meta_value_num', // 'meta_value_num' for numeric dates
                        'order' => 'DESC' // 'ASC' for descending order
                    ]); ?>
                        ...
                        <?php if ($events->have_posts()) : ?>
                            <div class="events-content__items">
                                <?php while ($events->have_posts()) : $events->the_post(); ?>
                                    ...
                                    var_dump(get_post_meta(get_the_ID(), '_crb_event_start_date', true));
                                    ?>
