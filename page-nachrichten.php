...
$lang === 'en' ? $cat_id = get_cat_ID('news') : $cat_id = get_cat_ID('nachrichten');
    ...
    <div class="container">
        <div class="blog-offer__wrapper">
            ...
            <div class="blog-offer__tabs">
                ...
                <a href="<?php echo $news_pages_link; ?>" data-id="<?php echo esc_attr($current_cat_id) ?>" class="blog-offer__tab _active">
                    <?php pll_e('News'); ?>
                </a>
                ...
                $terms = get_terms([
                    ...
                    'hide_empty' => true,
                    'orderby' => 'id',
                    'exclude'    => [$current_cat_id, $case_studies_cat_id, $blog_cat_id, $glossary_cat_id]
                ]);
                ?>
                <?php if ($terms): ?>
