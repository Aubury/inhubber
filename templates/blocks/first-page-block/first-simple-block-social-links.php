<?php
/**
 * Block template file: templates/blocks/first-page-block/first-simple-block-social-links.php
 *
 * First Simple Block Social Links Block Template.
 *
...
$id = 'first-simple-block-social-links-' . $block['id'];
if ( ! empty($block['anchor'] ) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$classes = 'block-first-simple-block-social-links';
