<?php
/**
 * Block template file: templates/blocks/main/contracts.php
 *
 * Contracts Block Template.
 *
...
$id = 'contracts-' . $block['id'];
if ( ! empty($block['anchor'] ) ) {
    $id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$classes = 'block-contracts';
...
<?php if(carbon_get_theme_option('crb_options_footer_info_block'. carbon_lang_prefix())): ?>
         <section id="<?php echo esc_attr( $id ); ?>" class="contracts  <?php echo esc_attr( $classes ); ?>">
            <div class="container">
